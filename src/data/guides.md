...
Guides are the instructions that steer an agent _before_ it acts — the highest-leverage part of the [harness](/). A well-configured guide layer determines whether your agent produces useful work on the first attempt or burns cycles on wrong approaches.
